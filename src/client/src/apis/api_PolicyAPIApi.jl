...
"""
basepath(::Type{ PolicyAPIApi }) = "http://localhost:8181"
...
function _oacinternal_delete_policy_module(_api::PolicyAPIApi, id::String; pretty=nothing, metrics=nothing, _mediaType=nothing)
...
"""
function delete_policy_module(_api::PolicyAPIApi, id::String; pretty=nothing, metrics=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_policy_module(_api, id; pretty=pretty, metrics=metrics, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_policy_module(_api::PolicyAPIApi, response_stream::Channel, id::String; pretty=nothing, metrics=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_policy_module(_api, id; pretty=pretty, metrics=metrics, _mediaType=_mediaType)
